/*
Stream-Eye #1:   Access Point, Streamer, html-page
*/
...
#include "VR-Eyes.h"  //Web page header file
...
void setup()
{
  ...
  Serial.begin(115200);
  delay(500); // wait for a 1/2 second to let Serial connect
  ...
  /*UXGA(1600x1200)
      ...
      QQVGA(160x120)
     */
  config.frame_size = FRAMESIZE_CIF;  // Reached the best results with CIF
